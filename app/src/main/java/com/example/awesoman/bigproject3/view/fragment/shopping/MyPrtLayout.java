 ...
 */
public class MyPrtLayout  extends PtrClassicFrameLayout {

    public MyPrtLayout(Context context) {
        super(context);
        initGesture();
    }

    public MyPrtLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initGesture();
    }

    public MyPrtLayout(Context context, AttributeSet attrs, int defStyle) {
